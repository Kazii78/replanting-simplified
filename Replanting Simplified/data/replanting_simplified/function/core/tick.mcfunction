...
execute as @a if predicate {condition: "entity_properties", entity: "this", predicate: {flags: {is_sneaking: false}}} run function replanting_simplified:features/raycast/initiate1
execute as @a if predicate {condition: "entity_properties", entity: "this", predicate: {flags: {is_sneaking: false}}} run function replanting_simplified:features/raycast/initiate2